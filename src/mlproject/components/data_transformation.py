...
class DataTransformation:
    ...
    def initiate_data_transormation(self,train_path,test_path):
        try:
            ...
            target_feature_train_df=train_df[target_column_name] # We can not perform preprocessing on target feature cause we have to predict it

            ## divide the test dataset to independent and dependent feature

            input_feature_test_df=test_df.drop(columns=[target_column_name],axis=1)
            target_feature_test_df=test_df[target_column_name] # We can not perform preprocessing on target feature cause we have to predict it
            ...
            # Concating input and target features for train and test dataset
            train_arr = np.c_[
